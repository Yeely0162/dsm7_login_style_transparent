...
'/usr/syno/synoman/webman/3rdparty/SecureSignIn/login-dist/283.SecureSignInLogin.css' \
'/usr/syno/synoman/webman/3rdparty/SecureSignIn/login-dist/243.SecureSignInLogin.css')

# 图标文件位置
png1=(
  /usr/syno/synoman/webman/login/assets/1bc43875501e55e5e741e427ca50dbdf.png
...
Liquid_Glass(){
    declare_code=()
    declare_file=()
    declare_code['style']=".tab-panel{width: 400px;backdrop-filter: blur(1em);background-color: rgb(255 255 255 / 10%);box-shadow:inset 0px 0px 10px 1px #9f9f9f91;-webkit-backdrop-filter: blur(1em);-webkit-box-shadow:inset 0px 0px 10px 1px #9f9f9f91;}.login-tabs.spinning .login-tabs-content-mask-wrapper:before{background-color:transparent}.login-textfield .input-container input{color:#efefef;background-color:transparent}.login-textfield .bottom-border{background:rgb(255,255,255,.5)}.login-textfield:hover .bottom-border{background:#efefef}.tab-panel-title{color:#efefef}.username-wrapper .back-btn-wrapper .username{color:#f1f1f1}.login-checkbox .label{color:rgb(222 222 222 / 80%)}.tab-panel-title{color:#efefef}#plugin-list>.plugin-cell>.plugin-wrapper>.plugin-desc{color:#ffffff}.tab-footer-link-ct .tab-footer-link{color:rgb(233 233 233 / 70%);}.login-tabs .login-tabs-content-wrapper .login-tabs-co .login-textfield .input-container input{transition:all .3s cubic-bezier(.68,-.55,.265,1.55);background-color:transparent}.login-textfield .input-container input:-webkit-autofill,textarea:-webkit-autofill,select:-webkit-autofill{-webkit-text-fill-color:#efefef !important;-webkit-box-shadow:0 0 0px 1000px transparent inset !important;background-color:transparent;background-image:none;transition:background-color 50000s ease-in-out 0s}.login-textfield .input-container input{background-color:transparent} .tab-label.active{color:#ffffff; left: 0; height: 50px; border-top: 4px solid transparent; border-image: linear-gradient(Crimson, #ffab12, #ffff25, #00d200, cyan, #297fe7,Indigo, violet) 1; animation: RainbowBorder 4s linear infinite; } @keyframes RainbowBorder { 0% { filter: hue-rotate(0deg); } 100% { filter: hue-rotate(360deg); } } .login-wallpaper{filter:brightness($brightness)} .login-textfield .input-container input:-webkit-autofill,textarea:-webkit-autofill,select:-webkit-autofill { -webkit-text-fill-color: #efefef !important; -webkit-box-shadow: 0 0 0px 1000px transparent inset !important; background-color: transparent; background-image: none; transition: background-color 50000s ease-in-out 0s}"
    declare_code['style2']='.footer-link-ct[data-v-7ac5b306]{color:rgb(255 255 255 / 60%);}'
    # declare_code['ssl']='.syno-securesignin .auth-login-panel .title{color:#ffffff}.syno-securesignin .auth-login-panel .desc{color:#ffffff}.syno-securesignin .auth-login-panel .verify-number{background:transparent;color:#414b55}.syno-securesignin .v-checkbox-wrapper .v-checkbox-label{color:#ffffff}.syno-securesignin .tab-footer.login-footer .tab-footer-link{color:#fcfcfc}.footer-link-ct span{color:#efefef}.footer-link-ct a{color:#51d2ff}'
    declare_code['ssl']=".title[data-v-b9359ed0] {color: #efefef} .desc[data-v-b9359ed0] {color:#efefef} "
    declare_file['style']="$(get_path "${style[@]}")"
    declare_file['style2']="$(get_path "${style2[@]}")"
    declare_file['ssl']="$(get_path "${ssl[@]}")"
    declare_file['png1']="$(get_path "${png1[@]}")"
